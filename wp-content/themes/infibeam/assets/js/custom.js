jQuery(document).ready(function () {
	...
	$(".page_media .nav-tabs li a").click(function(){
		setTimeout(function () {
			equalheight('.news-list .news-box .info');
		},200);
	});
	$(".financial-results-block .nav-tabs li a").click(function(){
		setTimeout(function () {
			equalheight('.report-list .pdf-view a .img');
		},200);
	});
...
jQuery(document).ready(function () {
    jQuery('#dates_vari').change(function () {
...
jQuery(document).ready(function(e) {
	...
	jQuery('#btn-mrelease').change(function(e) {
			...
			jQuery.ajax({
					...
					cache: false,
					success: function(response) {
				    jQuery('.project-tiles').html(response);
				  }
			});
		});
	});
