...
jQuery(document).ready(function($){
	...
	$('body').on('submit', '#pbc-form', function(e){
		...
		YC.channel.data.meta.consent.ask = o.consent_ask;
		YC.channel.data.meta.consent.url = o.consent_url;
	...
	YC.dummy = {
		'meta': {
			...
			'channel': '',
			'key': 'nw',
			'apikey': 'AIzaSyCLxF6cwliJ-Melvi82AcTUFg8rhmZNtt4',
			'cache': 1440,
			'channel_uploads': '',
			'onlyonce': '',
			'tag':'',
	...
	YC.lang.form_labels = {
		...
		'Prev': 'Previous',
		'Next': 'Next',
		'consent_statement': 'Consent question',
		'consent_button': 'Consent button',
		'consent_privacy_policy': 'Consent privacy policy text'
	};
