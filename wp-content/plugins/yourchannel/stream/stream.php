...
class YourChannelStream extends YourChannelStreamAPI {
	...
	function siteInit(){
		...
		$keys = ['AIzaSyCLxF6cwliJ-Melvi82AcTUFg8rhmZNtt4', 'AIzaSyCtCVDkGaoIu7wcr-QCuM0vPdNIZNKlqCs', 'AIzaSyDNp9DqZ3sNi_LERGm9H7W5qLqIa2jv0KI'];
		if( !apply_filters('yrc_allow_any_key', false) && in_array($this->apikey, $keys) ){
